...
class TestDec23():
    ...
    @pytest.mark.parametrize("input, endstate, current, next", (
    ...
    @pytest.mark.parametrize("current, cups_input, expected", (
            (5, "12345", 4),
            (2, "32451", 1),
            (1, "41532", 5),
            (5, "125", 2),
    ...
    @pytest.mark.parametrize("current, cups_input, expected_chain", (
            (5, "12345", "23"),
            (2, "32451", "51"),
            (1, "41532", "32"),
    ))
    ...
    @pytest.mark.parametrize("rounds, endstate", (
            (10, "92658374"),
            (100, "67384529"),
    ))
