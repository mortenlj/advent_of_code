...
@pytest.mark.parametrize("lines, io, europa, ganymede, callisto", (
        (["<x=-1, y=0, z=2>",
          "<x=2, y=-10, z=-7>",
          "<x=4, y=-8, z=8>",
          "<x=3, y=5, z=-1>"],
...
@pytest.mark.parametrize("moons, steps, final_moons", (
        ([Moon("Io", -1, 0, 2),
          Moon("Europa", 2, -10, -7),
          Moon("Ganymede", 4, -8, 8),
          Moon("Callisto", 3, 5, -1)],
...
@pytest.mark.parametrize("moons, steps", (
        ([Moon("Io", -1, 0, 2),
          Moon("Europa", 2, -10, -7),
          Moon("Ganymede", 4, -8, 8),
          Moon("Callisto", 3, 5, -1)], 2772),
        ([Moon("Io", -8, -10, 0),
          Moon("Europa", 5, 5, 10),
          Moon("Ganymede", 2, -7, 3),
          Moon("Callisto", 9, -8, -3)], 4686774924),
))
