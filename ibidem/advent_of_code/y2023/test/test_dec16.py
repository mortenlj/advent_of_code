...
from ibidem.advent_of_code.y2023.dec16 import (
    load,
    part1,
    part2,
    handle_point,
...
class TestDec16:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (Beam(5, 5, Direction.UP), ".", [Beam(5, 4, Direction.UP)]),
            (
                Beam(5, 5, Direction.UP),
                "-",
                [Beam(4, 5, Direction.LEFT), Beam(6, 5, Direction.RIGHT)],
            ),
            (Beam(5, 5, Direction.UP), "/", [Beam(6, 5, Direction.RIGHT)]),
            (Beam(5, 5, Direction.UP), "\\", [Beam(4, 5, Direction.LEFT)]),
            (
                Beam(5, 5, Direction.LEFT),
                "|",
                [Beam(5, 4, Direction.UP), Beam(5, 6, Direction.DOWN)],
            ),
        ],
    )
